...
public class QuestionXunLianJiLuVo {
    ...
    public static QuestionXunLianJiLuVo fromQuestionXunLianJiLu(QuestionXunLianJiLu questionXunLianJiLu) {
        QuestionXunLianJiLuVo questionXunLianJiLuVo = new QuestionXunLianJiLuVo();
        BeanUtils.copyProperties(questionXunLianJiLu, questionXunLianJiLuVo);
        return questionXunLianJiLuVo;
    }
