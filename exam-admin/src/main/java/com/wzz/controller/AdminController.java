...
public class AdminController {
    ...
    @ApiOperation("管理员查看个人用户数据")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "user", value = "系统用户实体", required = true, dataType = "user", paramType = "body")
    })
    public CommonResult<UserInfoVo> getUserById(@PathVariable("id") Integer id) {
    ...
    @ApiOperation("更新用户")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "user", value = "用户对象", required = true, dataType = "notice", paramType = "body")
    })
    public CommonResult<Void> updateUser(@RequestBody User user) {
