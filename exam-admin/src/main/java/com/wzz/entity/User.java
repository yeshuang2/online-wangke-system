...
public class User implements Serializable {
    ...
    @ApiModelProperty(value = "用户角色id", example = "1(学生) 2(部门经理) 3(管理员)")
    ...
    @ApiModelProperty(value = "用户状态", example = "1正常 2待审核")
    private Integer status;

    @ApiModelProperty(value = "用户创建时间", example = "2022-10-22 10:35:44")
